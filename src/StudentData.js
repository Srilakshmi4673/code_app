...
function StudentData() {
    ...
    useEffect(() => {
        fetch(`https://student-app-api-i67y.onrender.com/StudentDetail`)
            .then((res) => res.json())
            .then((resp) => {
                setData(resp);
            })
    ...
    const changeDelete = (id) => {
        fetch("https://student-app-api-i67y.onrender.com/StudentDetail" + id, {
            method: "DELETE",
        })
            .then(() => {
    ...
    const handleSearch = () => {
        return axios.get(`https://student-app-api-i67y.onrender.com/StudentDetail?q=${value}`)
            .then((res) => {
                setData(res.data);
            })
            .catch((err) => {
    ...
    const sortData = async (e) => {
        ...
        setSort(value);
        return await axios.get(`https://student-app-api-i67y.onrender.com/StudentDetail?_sort=${value}&_order=asc`) //desc
            .then((res) => {
                setData(res.data);
            })
            .catch((err) => {
